...
# ===============================
df = pd.read_csv("screening_NiFeCo_large.csv")
...
# 4. LOAD MODEL
# ===============================
model = joblib.load("xgb_fullfeature_model.joblib")
...
# 7. SAVE RESULTS
# ===============================
df.to_csv("screening_predictions_large_xgb.csv", index=False)
best.to_csv("screening_best_candidates_large_NiFeCo_xgb.csv", index=False)
